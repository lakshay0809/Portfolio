  ...
  const data = [
    {
      ...
      desc: "For frontend I use React , expert in HTML ,CSS ,JS and bootstrap. For Backend I am currently learning Node js by making various projects.For mobile development I uses flutter.",
    },
    {
      id: 2,
